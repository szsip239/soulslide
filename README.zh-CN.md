...
|---|---|---|---|---|---|---|---|
| 00 | 观众如何导航，并看到开发进度 | `navigation.html` | 章节列表、页面状态、控制栏 | 不需要 | 上一页/下一页/全屏 | 先生成 | 确认页面分组 |
...
- `navigation.html`：deck 目录、开发状态页、播放控制栏
...
- `references/deck-shell.md`：导航/状态页和播放控制栏规则
