...
请返回一个表格：页码、这一页的一句话主旨、推荐 SoulSlide 模板、内容模块、是否需要视觉资产、是否需要交互、待确认问题。
```
...
| 页码 | 一句话主旨 | 推荐模板 | 内容模块 | 视觉资产 | 交互 | 待确认问题 |
|---|---|---|---|---|---|---|
| 01 | 观众应该记住什么 | `cover.html` | 标题、副标题、讲者/活动 | 可选背景图 | 无 | 确认标题 |
| 02 | 一个判断、对比、流程或证据点 | 模板名 | 最多 3-5 个模块 | 已提供/需生成/不需要 | 无/翻页笔 | 缺什么材料 |
